...
for(const name of ['Wall','Floor','Ceiling','Fixture','DoorFrame','Outlet','Desk','Chair','Cabinet','IncidentPoster','WellnessPoster','DirectionPoster','Portrait','Door','CameraHead']){const m=new THREE.Mesh(new THREE.BoxGeometry(1,1,1),new THREE.MeshStandardMaterial());m.name=name;kit.add(m);props.add(m.clone());}
