...
const progressSave={version:1,seed:8,floor:1,index:1,minVisited:0,maxVisited:1,facilities:18,milestones:[[0,true],[2,false]],flashlight:true,complete:false};assert.ok(writeCheckpoint(progressSave,storage));assert.deepEqual(readCheckpoint(storage),progressSave,'Generated-area progress survives independently of coordinate range');
