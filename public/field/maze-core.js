...
export class MazeTopology{
 constructor(seed=Date.now(),offset={x:0,z:0},floor=null){this.floor=floor;this.offset=offset;this.seed=seed>>>0;this.origin=0;this.current=0;this.chunks=new Map();this.milestones=new Map();this.history=new Map();this.serial=0;this.discovered=0;this.mutations=0;this.maxDepth=0;this.minVisited=0;this.maxVisited=0;this.minMade=Infinity;this.maxMade=-Infinity;this.ensure(0);}
