...
export function validCheckpoint(value){
 ...
 return{...(value.milestones?{milestones:value.milestones}:{}),version:1,seed:value.seed,floor:value.floor,index:value.index,minVisited:value.minVisited,maxVisited:value.maxVisited,flashlight:value.flashlight!==false,complete:value.complete===true};
}
